...
Primary tokens define the colors used to highligh calls to action for example. The primary color is usually your brand primary color.

### As foreground color

<Story of={ColorsStories.PrimaryAsForeground} />

### As background color

<Story of={ColorsStories.PrimaryAsBackground} />

### As borders color

<Story of={ColorsStories.PrimaryAsBorders} />
