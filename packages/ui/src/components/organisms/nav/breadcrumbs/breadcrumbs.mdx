...
When an item label is too long, it should be truncated. You can control the maximum length using the `maxLength` property.

<Canvas of={BreadcrumbsStories.TruncatedItem} />
